...
public class IStockQuoteServiceGetStockQuoteDefaultFaultContractFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IStockQuoteServiceGetStockQuoteDefaultFaultContractFaultFaultMessage(String message, DefaultFaultContract faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IStockQuoteServiceGetStockQuoteDefaultFaultContractFaultFaultMessage(String message, DefaultFaultContract faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
