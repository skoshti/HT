...
public class GetWorldMajorIndicesResponse {
    ...
    @XmlElementRef(name = "GetWorldMajorIndicesResult", namespace = "http://www.restfulwebservices.net/ServiceContracts/2008/01", type = JAXBElement.class, required = false)
    ...
    public void setGetWorldMajorIndicesResult(JAXBElement<ArrayOfStockQuote> value) {
        this.getWorldMajorIndicesResult = value;
    }
