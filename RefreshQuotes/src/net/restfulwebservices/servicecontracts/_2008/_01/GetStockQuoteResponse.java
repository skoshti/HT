...
public class GetStockQuoteResponse {
    ...
    @XmlElementRef(name = "GetStockQuoteResult", namespace = "http://www.restfulwebservices.net/ServiceContracts/2008/01", type = JAXBElement.class, required = false)
    ...
    public void setGetStockQuoteResult(JAXBElement<StockQuote> value) {
        this.getStockQuoteResult = value;
    }
